...
public class MoveSiblingMcrIntoLink implements IssueFix {
    ...
    // TODO: Move to a utility class (same as @getAnnotationBounds in @EmptyLinkTagRule?)
    ...
    // TODO: Move to a utility class (same as @getQuadPointsBounds in @EmptyLinkTagRule?)
    ...
    // TODO: Move to a utility class (same as @getRectBounds in @EmptyLinkTagRule?)
    ...
    // TODO: Move to a utility class (same as @boundsSimilar in @EmptyLinkTagRule?)
    ...
    // TODO: Move to a utility class (same as @area in @EmptyLinkTagRule?)
